...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2025 at 01:28 PM
...
(13, 2, 46, NULL, NULL, NULL, 4, 4, 'CERT-2025-LFDCE6', 'issued', '2025-11-02 01:58:58', 1, NULL, '2025-11-02 01:58:58', '2025-11-02 01:58:58'),
(14, 3, 44, NULL, NULL, NULL, 2, 4, 'CERT-2025-87IYTN', 'issued', '2025-11-22 01:52:45', 1, NULL, '2025-11-22 01:52:45', '2025-11-22 01:52:45'),
(15, 7, 50, NULL, NULL, NULL, 2, 11, 'CERT-2025-PRFHUJ', 'issued', '2025-12-17 06:21:36', 1, NULL, '2025-12-17 06:21:36', '2025-12-17 06:21:36'),
(16, 8, 51, NULL, NULL, NULL, 6, 11, 'CERT-2025-BM6IHK', 'issued', '2025-12-19 06:51:10', 1, NULL, '2025-12-19 06:31:25', '2025-12-19 06:51:10');
...
CREATE TABLE `certificate_requests` (
  ...
  `certificate_type` varchar(255) NOT NULL DEFAULT 'Course Completion Certificate',
  `amount` decimal(8,2) NOT NULL DEFAULT 0.00,
  `payment_id` bigint(20) UNSIGNED DEFAULT NULL,
  `status` enum('pending','approved','paid','completed','rejected') NOT NULL DEFAULT 'pending',
...
INSERT INTO `certificate_requests` (`id`, `enrollment_id`, `franchise_id`, `student_id`, `course_id`, `certificate_type`, `amount`, `payment_id`, `status`, `payment_status`, `paid_at`, `wallet_transaction_id`, `notes`, `note`, `approved_by`, `approved_at`, `rejected_by`, `rejected_at`, `rejection_reason`, `admin_notes`, `processed_by`, `processed_at`, `certificate_number`, `issued_date`, `requested_at`, `created_at`, `updated_at`) VALUES
(1, NULL, 4, 43, 2, 'Course Completion Certificate', 0.00, 24, 'approved', 'pending', NULL, NULL, NULL, NULL, 1, '2025-10-28 03:27:57', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-10-27 06:24:54', '2025-10-27 06:24:54', '2025-10-28 03:27:57'),
(2, NULL, 4, 46, 4, 'Course Completion Certificate', 0.00, 27, 'approved', 'pending', NULL, NULL, NULL, NULL, 1, '2025-11-02 01:58:58', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-02 01:48:31', '2025-11-02 01:48:31', '2025-11-02 01:58:58'),
(3, NULL, 4, 44, 2, 'Standard Certificate', 100.00, NULL, 'approved', 'pending', NULL, NULL, 'hgjhgjhg', NULL, 1, '2025-11-22 01:52:45', NULL, NULL, NULL, 'yes , this payment is successfully done.so i am approving this ', NULL, NULL, NULL, NULL, NULL, '2025-11-05 10:40:27', '2025-11-22 01:52:45'),
(7, NULL, 11, 50, 2, 'Course Completion Certificate', 100.00, NULL, 'approved', 'pending', NULL, NULL, '', NULL, 1, '2025-12-17 06:21:36', NULL, NULL, NULL, 'i want to approve this certificate for rajesh singh', NULL, NULL, NULL, NULL, '2025-12-17 06:20:47', '2025-12-17 06:20:47', '2025-12-17 06:21:36'),
(8, NULL, 11, 51, 6, 'Course Completion Certificate', 100.00, NULL, 'completed', 'paid', '2025-12-19 06:37:06', 12, '', NULL, 1, '2025-12-19 06:31:25', NULL, NULL, NULL, 'yes approved\n', NULL, NULL, 'CERT-2025-BM6IHK', NULL, '2025-12-19 06:30:55', '2025-12-19 06:30:55', '2025-12-19 06:51:10');
...
(4, 'Advanced Web Development', 'AWD2025', 'Complete web development course with modern technologies and frameworks', 100.00, 500.00, 480.00, 0, 450.00, '', 8, 'HTML5, CSS3, JavaScript ES6+, React, Node.js, Laravel, MySQL, Git, AWS deployment', 'Basic computer knowledge, willingness to learn', 'advanced', '[\"Build full-stack web applications\",\"Master React and Laravel\",\"Deploy applications to cloud\"]', NULL, 'technology', 30, 70.00, 'John Smith', 'john@example.com', NULL, '[\"react\",\"laravel\",\"javascript\",\"php\",\"mysql\"]', 0, NULL, 'active', '2025-10-17 01:29:40', '2025-12-06 03:13:56'),
...
(11, 50, 2, 11, '2025-12-16 05:23:44', NULL, 1.00, 'pending', 'active', NULL, NULL, NULL, 0, '2025-12-16 05:23:44', '2025-12-16 05:23:44', NULL);
...
(5, 'Alpha strategy ', 'ALPSTR001', 'satyamkprajapati2001@gmail.com', '1234567890', 'kumhari', 'BHILAI', 'Chhattisgarh', '490042', 'tester', '2000-10-02', 'nothing', 'active', '2025-10-19 11:40:23', '2025-12-05 05:40:30'),
(11, 'Vyom franchise', 'F001', 'vyom@gmail.com', '1526348792', 'Nehru Nagar', 'Bhilai', 'Chhattisgarh', '490042', 'Vyom Pandey', '2025-12-05', 'This is new franchise for Vyom.', 'active', '2025-12-05 05:46:12', '2025-12-05 05:46:12');
...
(1, 4, 1200.00, '2025-11-02 07:31:07', '2025-11-09 02:01:27'),
(5, 5, 0.00, '2025-12-05 05:22:41', '2025-12-05 05:22:41'),
(6, 11, 400.00, '2025-12-05 06:02:54', '2025-12-19 06:37:06');
...
(1, 4, 'credit', 100.00, 'wallet_topup', NULL, 'completed', NULL, '\"{\\\"ip_address\\\":\\\"127.0.0.1\\\",\\\"user_agent\\\":\\\"Mozilla\\\\\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\\\\\/537.36 (KHTML, like Gecko) Chrome\\\\\\/142.0.0.0 Safari\\\\\\/537.36\\\",\\\"initiated_at\\\":\\\"2025-11-03T17:44:38.790195Z\\\"}\"', NULL, '2025-11-03 12:14:38', '2025-11-03 12:14:38'),
(2, 4, 'credit', 2000.00, 'wallet_topup', NULL, 'completed', NULL, '\"{\\\"ip_address\\\":\\\"127.0.0.1\\\",\\\"user_agent\\\":\\\"Mozilla\\\\\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\\\\\/537.36 (KHTML, like Gecko) Chrome\\\\\\/142.0.0.0 Safari\\\\\\/537.36\\\",\\\"initiated_at\\\":\\\"2025-11-03T17:48:28.240786Z\\\"}\"', NULL, '2025-11-03 12:18:28', '2025-11-03 12:18:28'),
(3, 4, 'credit', 500.00, 'wallet_topup', 'upi', 'pending', NULL, '\"{\\\"ip_address\\\":\\\"127.0.0.1\\\",\\\"user_agent\\\":\\\"Mozilla\\\\\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\\\\\/537.36 (KHTML, like Gecko) Chrome\\\\\\/142.0.0.0 Safari\\\\\\/537.36\\\",\\\"initiated_at\\\":\\\"2025-11-05T15:09:18.189847Z\\\"}\"', NULL, '2025-11-05 09:39:18', '2025-11-05 09:39:18'),
(4, 4, 'credit', 500.00, 'wallet_topup', 'upi', 'pending', NULL, '\"{\\\"ip_address\\\":\\\"127.0.0.1\\\",\\\"user_agent\\\":\\\"Mozilla\\\\\\/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit\\\\\\/537.36 (KHTML, like Gecko) Chrome\\\\\\/142.0.0.0 Safari\\\\\\/537.36\\\",\\\"initiated_at\\\":\\\"2025-11-09T07:09:17.869232Z\\\"}\"', NULL, '2025-11-09 01:39:17', '2025-11-09 01:39:17'),
(5, 11, 'credit', 500.00, 'wallet_topup', 'razorpay', 'completed', NULL, '\"{\\\"ip_address\\\":\\\"127.0.0.1\\\",\\\"user_agent\\\":\\\"Mozilla\\\\\\/5.0 (Windows NT 10.0; Win64; x64; rv:146.0) Gecko\\\\\\/20100101 Firefox\\\\\\/146.0\\\",\\\"initiated_at\\\":\\\"2025-12-17T11:52:40.377716Z\\\"}\"', '2025-12-17 06:23:23', '2025-12-17 06:22:40', '2025-12-17 06:23:23');
...
(32, '2025_11_02_115521_create_franchise_wallets_table', 20),
(33, '2025_11_02_115606_create_franchise_wallet_transactions_table', 20),
(34, '2025_11_03_175701_add_status_and_payment_method_to_franchise_wallet_transactions', 21),
(35, '2025_11_05_122210_add_certificate_fee_to_courses_table', 22),
(36, '2025_11_05_160120_create_wallet_transactions_table', 23),
(37, '2025_11_05_160357_add_certificate_type_to_certificate_requests_table', 24),
(38, '2025_11_05_160616_add_amount_to_certificate_requests_table', 25),
(39, '2025_11_09_055044_create_wallet_recharge_requests_table', 26),
(40, '2025_11_09_055139_create_wallet_audit_logs_table', 26),
(41, '2025_12_17_072258_add_payment_fields_to_certificate_requests_table', 27),
(42, '2025_12_19_120510_add_paid_status_to_certificate_requests_table', 28);
...
(17, 'ORD68FF52F8982B1', NULL, 43, 2, 11.00, 'INR', 'pending', 'razorpay', NULL, NULL, NULL, NULL, NULL, '2025-10-27 05:39:44', '2025-10-27 05:39:44'),
...
(27, 'ORD690705A68951F', NULL, 46, 4, 78.00, 'INR', 'completed', 'manual', NULL, 'MANUAL_1762067878', NULL, '', '2025-11-02 01:47:58', '2025-11-02 01:47:58', '2025-11-02 01:47:58');
...
INSERT INTO `students` (`id`, `student_id`, `franchise_id`, `name`, `middle_name`, `last_name`, `father_name`, `mother_name`, `email`, `phone`, `date_of_birth`, `gender`, `address`, `city`, `state`, `pincode`, `guardian_name`, `guardian_phone`, `status`, `created_at`, `updated_at`, `course_id`, `enrollment_date`, `batch`, `notes`, `profile_photo`, `deleted_at`) VALUES
...
(41, 'STU000041', 5, 'Satyam Kumar', '', '', '', '', 'apha@gmail.com', '1234567890', '2024-01-30', 'male', 'STR C9 HOUSING BOARD COLONY,MAHAMAYA ROAD,H.P. GAS AGENCY, WARD NO 14,KUMHARI', 'DURG-BHILAI', 'Chhattisgarh', '490042', 'alpha 123', '1234567890', 'active', '2025-10-22 00:41:21', '2025-11-02 00:48:02', 2, '2025-10-22', 'batch-2025', NULL, NULL, NULL),
...
(46, 'STUSK A12F85', 4, 'VIRAT', '', '', '', '', 'abv@gmail.com', '768597666', '2002-11-13', NULL, 'bhilai', 'DURG', 'CG', '490042', NULL, NULL, 'active', '2025-11-02 01:40:02', '2025-11-02 01:40:02', 2, '2025-11-02', NULL, NULL, NULL, NULL),
(50, 'STUVYOD06D1B', 11, 'Rajesh singh', '', '', 'Ranveer singh', 'Kusum singh', 'rajesh@gmail.com', '1234567895', '1994-02-18', NULL, 'shnati nagar bhilai', 'bhilai', 'chhhattisgarh', '480025', NULL, NULL, 'active', '2025-12-16 05:23:33', '2025-12-16 05:23:33', 2, '2025-12-16', NULL, NULL, NULL, NULL),
(51, 'STUVYOB7B74D', 11, 'Deepak ', 'Singh', 'yadav', 'Praveen yadav', 'Deepa yadav', 'deepak@gmail.com', '1526348790', '2004-11-18', NULL, 'Up Baghalpur', 'Mugffarabad', 'uttar pradesh', '152630', NULL, NULL, 'active', '2025-12-16 05:41:39', '2025-12-16 05:41:39', 6, '2025-12-16', NULL, NULL, NULL, NULL);
...
(4, 'mr ajit ', 'satyamkprajapati2001@gmail.com', NULL, 'franchise', 5, NULL, '$2y$10$bAq24nMUw9Hunjc27cQR/Oy9rEp7OM71lHtpfI0fdbn0yfQlH/avu', '7Pf1I18RS1WwHlh0Mv1HjbpcBIxV4YWHtaLHZlyDQFQTq5jPWpOtziws1EEW', '2025-10-19 11:40:23', '2025-12-05 05:21:23'),
...
(14, 'VIRAT ', 'ANB@GMAIL.COM', NULL, 'student', NULL, NULL, '$2y$10$ZRbqwNmwASzQQsO1Z5LR.OOLMKMCC4cVUurFmGVyYDqh/XYWLehlW', NULL, '2025-11-02 01:44:45', '2025-11-02 01:44:45'),
(15, 'Vyom Pandey', 'vyom@gmail.com', NULL, NULL, 11, NULL, '$2y$10$4gzmp8iFdzA2vUU2P4OEgOR2hv4fQLqExxA7TcUxaDLxdK8SGOaFO', NULL, '2025-12-05 05:46:12', '2025-12-05 06:45:12');
...
--
-- Dumping data for table `wallet_audit_logs`
--

INSERT INTO `wallet_audit_logs` (`id`, `franchise_id`, `action`, `old_balance`, `new_balance`, `amount_changed`, `performed_by`, `ip_address`, `user_agent`, `details`, `created_at`) VALUES
(1, 4, 'debit_deducted', 1900.00, 1400.00, 500.00, 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:144.0) Gecko/20100101 Firefox/144.0', '{\"timestamp\":\"2025-11-09 07:12:54\",\"route\":\"admin.wallet.process-manual\"}', '2025-11-09 01:42:54'),
(2, 4, 'debit_deducted', 1400.00, 1300.00, 100.00, 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:144.0) Gecko/20100101 Firefox/144.0', '{\"timestamp\":\"2025-11-09 07:23:36\",\"route\":\"admin.wallet.process-manual\"}', '2025-11-09 01:53:36'),
(3, 4, 'credit_added', 1300.00, 1400.00, 100.00, 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:144.0) Gecko/20100101 Firefox/144.0', '{\"timestamp\":\"2025-11-09 07:25:21\",\"route\":\"admin.wallet.process-manual\"}', '2025-11-09 01:55:21'),
(4, 4, 'debit_deducted', 1400.00, 1200.00, 200.00, 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:144.0) Gecko/20100101 Firefox/144.0', '{\"timestamp\":\"2025-11-09 07:31:27\",\"route\":\"admin.wallet.process-manual\"}', '2025-11-09 02:01:27');
...
CREATE TABLE `wallet_recharge_requests` (
  ...
  `franchise_id` bigint(20) UNSIGNED NOT NULL,
  `amount` decimal(10,2) NOT NULL,
  `payment_method` enum('bank_transfer','upi','card','cash','cheque') NOT NULL DEFAULT 'upi',
...
CREATE TABLE `wallet_transactions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `franchise_wallet_id` bigint(20) UNSIGNED NOT NULL,
  `type` enum('credit','debit') NOT NULL,
  `amount` decimal(10,2) NOT NULL,
  `description` text DEFAULT NULL,
  `status` enum('pending','completed','failed','refunded') NOT NULL DEFAULT 'pending',
...
INSERT INTO `wallet_transactions` (`id`, `franchise_wallet_id`, `type`, `amount`, `description`, `status`, `balance_after`, `transaction_id`, `payment_method`, `metadata`, `created_at`, `updated_at`) VALUES
(4, 1, 'debit', 100.00, 'Certificate request for anshu kumar - Digital Marketing Mastery', 'completed', 1900.00, NULL, NULL, NULL, '2025-11-05 10:40:27', '2025-11-05 10:40:27'),
(5, 1, 'debit', 500.00, 'this is for default money deducted', 'completed', 1400.00, NULL, NULL, '{\"performed_by\":1,\"ip_address\":\"127.0.0.1\"}', '2025-11-09 01:42:54', '2025-11-09 01:42:54'),
(6, 1, 'debit', 100.00, 'dummy deduct', 'completed', 1300.00, NULL, NULL, '{\"performed_by\":1,\"ip_address\":\"127.0.0.1\"}', '2025-11-09 01:53:36', '2025-11-09 01:53:36'),
(7, 1, 'credit', 100.00, 'hello', 'completed', 1400.00, NULL, NULL, '{\"manual_transaction\":true,\"performed_by\":1,\"ip_address\":\"127.0.0.1\",\"timestamp\":\"2025-11-09 07:25:21\"}', '2025-11-09 01:55:21', '2025-11-09 01:55:21'),
(8, 1, 'debit', 200.00, '200deducted from your account sk', 'completed', 1200.00, NULL, NULL, '{\"performed_by\":1,\"ip_address\":\"127.0.0.1\"}', '2025-11-09 02:01:27', '2025-11-09 02:01:27'),
(12, 6, 'debit', 100.00, 'Payment for certificate - Deepak  Singh yadav - Python AI Course', 'completed', 400.00, NULL, NULL, NULL, '2025-12-19 06:37:06', '2025-12-19 06:37:06');
...
ALTER TABLE `certificate_requests`
  ...
  ADD KEY `certificate_requests_wallet_transaction_id_foreign` (`wallet_transaction_id`),
...
--
-- Indexes for table `wallet_audit_logs`
--
ALTER TABLE `wallet_audit_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `wallet_audit_logs_franchise_id_created_at_index` (`franchise_id`,`created_at`),
  ADD KEY `wallet_audit_logs_performed_by_index` (`performed_by`),
  ADD KEY `wallet_audit_logs_action_index` (`action`);
...
ALTER TABLE `wallet_recharge_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `wallet_recharge_requests_verified_by_foreign` (`verified_by`),
  ADD KEY `wallet_recharge_requests_franchise_id_status_index` (`franchise_id`,`status`),
  ADD KEY `wallet_recharge_requests_requested_at_index` (`requested_at`);
...
ALTER TABLE `wallet_transactions`
  ...
  ADD KEY `wallet_transactions_franchise_wallet_id_index` (`franchise_wallet_id`),
...
--
-- AUTO_INCREMENT for table `wallet_audit_logs`
--
ALTER TABLE `wallet_audit_logs`
...
ALTER TABLE `certificate_requests`
  ...
  ADD CONSTRAINT `certificate_requests_franchise_id_foreign` FOREIGN KEY (`franchise_id`) REFERENCES `franchises` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `certificate_requests_payment_id_foreign` FOREIGN KEY (`payment_id`) REFERENCES `payments` (`id`),
  ADD CONSTRAINT `certificate_requests_processed_by_foreign` FOREIGN KEY (`processed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ...
  ADD CONSTRAINT `certificate_requests_wallet_transaction_id_foreign` FOREIGN KEY (`wallet_transaction_id`) REFERENCES `wallet_transactions` (`id`) ON DELETE SET NULL;
...
--
-- Constraints for table `wallet_audit_logs`
--
ALTER TABLE `wallet_audit_logs`
  ADD CONSTRAINT `wallet_audit_logs_franchise_id_foreign` FOREIGN KEY (`franchise_id`) REFERENCES `franchises` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `wallet_audit_logs_performed_by_foreign` FOREIGN KEY (`performed_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `wallet_recharge_requests`
--
ALTER TABLE `wallet_recharge_requests`
  ADD CONSTRAINT `wallet_recharge_requests_franchise_id_foreign` FOREIGN KEY (`franchise_id`) REFERENCES `franchises` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `wallet_recharge_requests_verified_by_foreign` FOREIGN KEY (`verified_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `wallet_transactions`
--
ALTER TABLE `wallet_transactions`
  ADD CONSTRAINT `wallet_transactions_franchise_wallet_id_foreign` FOREIGN KEY (`franchise_wallet_id`) REFERENCES `franchise_wallets` (`id`) ON DELETE CASCADE;
COMMIT;
